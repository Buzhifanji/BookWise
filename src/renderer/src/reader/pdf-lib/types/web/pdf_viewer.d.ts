...
export type OptionalContentConfig =
  import('../src/display/optional_content_config.js').OptionalContentConfig
export const EventBus = import('./event_utils.js').EventBus
...
export const PDFFindController = import('./pdf_find_controller.js').PDFFindController
export type PDFScriptingManager = import('./pdf_scripting_manager.js').PDFScriptingManager

export const PDFLinkService = import('./pdf_link_service.js').PDFLinkService
...
export class PDFViewer {
  ...
  _optionalContentConfigPromise:
    | Promise<import('../src/display/optional_content_config.js').OptionalContentConfig>
    | null
    | undefined
  /**
  ...
  set optionalContentConfigPromise(
    promise: Promise<
      import('../src/display/optional_content_config.js').OptionalContentConfig | null
    >
  )
  /**
   * @type {Promise<OptionalContentConfig | null>}
   */
  get optionalContentConfigPromise(): Promise<
    import('../src/display/optional_content_config.js').OptionalContentConfig | null
  >
  /**
