...
export type TextAccessibilityManager =
  import('../../../web/text_accessibility.js').TextAccessibilityManager
...
export class AnnotationEditorLayer {
  ...
  static '__#27@#editorTypes': Map<
    number,
    typeof FreeTextEditor | typeof HighlightEditor | typeof InkEditor | typeof StampEditor
  >
  /**
