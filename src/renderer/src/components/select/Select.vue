...
<template>
  <details class="dropdown " :class="position" ref="detailsRef">
    ...
    <ul
      class="p-2  mt-2  dropdown-content  z-[10] max-h-60 md:max-h-72 lg:max-h-96 w-full overflow-auto border badge-accent badge-outline  rounded-md menu flex-nowrap  bg-base-100 shadow-2xl  gap-1 scrollbar-thin ">
