...
const common = {
  ...
  search: "cari",
  noRegList: "Tiada senarai yang sepadan"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Bilangan buku",
  bookshelfManage: "Menguruskan rak buku",
  bookshelfTitle: "nama rak buku",
  clearEmptyBookshelf: "Kosongkan rak buku kosong dengan satu klik",
  removeBookshelfSuccess: "Rak buku berjaya dikeluarkan",
  removeBookshelftSuccess: "Rak buku berjaya dikeluarkan",
  renameFail: "Gagal menamakan semula rak buku"
};
const note = {
  ...
  mode: "mod nota",
  noteNumber: "Bilangan nota"
};
const tag = {
  needTag: "Sila masukkan tag",
  removeTagSuccess: "Tag berjaya dipadamkan",
  name: "Label",
  clearEmptyTag: "Kosongkan tag kosong dengan satu klik",
  getTagListFail: "Gagal mendapatkan senarai rak buku",
  manage: "pengurusan tag",
  renameFail: "Gagal menamakan semula rak buku:",
  tagTitle: "tag nama"
};
const statistics = {
...
const search = {
  searchRange: "Cari buku, nota, tag, sorotan, rak buku"
};
const ms = {
  menu,
  setting,
