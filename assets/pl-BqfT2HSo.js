...
const common = {
  ...
  add: "Dodać do",
  copy: "Kopiuj",
  prewView: "Poprzednia strona",
  getFirstView: "Już pierwsza strona",
  getLastView: "Już ostatnia strona",
  nextView: "Następna strona",
  comeFrom: "z",
  action: "działać",
  rename: "Przemianować",
  search: "szukaj",
  noRegList: "Brak pasującej listy"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Liczba książek",
  bookshelfManage: "Zarządzaj półką z książkami",
  bookshelfTitle: "nazwa półki na książki",
  clearEmptyBookshelf: "Wyczyść pustą półkę jednym kliknięciem",
  removeBookshelfSuccess: "Półka na książki została pomyślnie usunięta",
  removeBookshelftSuccess: "Półka na książki została pomyślnie usunięta",
  renameFail: "Nie udało się zmienić nazwy półki na książki"
};
const note = {
  ...
  write: "pisać pomysły",
  myNote: "moje notatki",
  findNoteError: "Utrata danych: Notatka nie została znaleziona lokalnie",
  writeYouNore: "Proszę wpisać treść notatki",
  mode: "tryb notatki",
  noteNumber: "Liczba notatek"
};
const tag = {
  needTag: "Proszę wpisać tag",
  removeTagSuccess: "Tag został pomyślnie usunięty",
  name: "Etykieta",
  clearEmptyTag: "Wyczyść puste tagi jednym kliknięciem",
  getTagListFail: "Nie udało się pobrać listy półek na książki",
  manage: "zarządzanie tagami",
  renameFail: "Nie udało się zmienić nazwy półki na książki:",
  tagTitle: "Nazwa znacznika"
};
const statistics = {
  bookUnit: "Książka",
  noteUnit: "Rozdział",
...
const sort = {
  ...
  updateTime: "Niedawno przeczytane"
};
const search = {
  searchRange: "Szukaj książek, notatek, tagów, najważniejszych wydarzeń, półek na książki"
};
const pl = {
  menu,
  setting,
