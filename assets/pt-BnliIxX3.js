...
const common = {
  ...
  add: "adicionar à",
  copy: "cópia de",
  prewView: "Página anterior",
  getFirstView: "Já é a primeira página",
  getLastView: "Já é a última página",
  nextView: "Próxima página",
  comeFrom: "de",
  action: "operar",
  rename: "Renomear",
  search: "procurar",
  noRegList: "Nenhuma lista correspondente"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Número de livros",
  bookshelfManage: "Gerenciar estante",
  bookshelfTitle: "nome da estante",
  clearEmptyBookshelf: "Limpe a estante vazia com um clique",
  removeBookshelfSuccess: "Estante removida com sucesso",
  removeBookshelftSuccess: "Estante removida com sucesso",
  renameFail: "Falha ao renomear estante"
};
const note = {
  ...
  myNote: "minhas anotações",
  findNoteError: "Perda de dados: nota não encontrada localmente",
  writeYouNore: "Por favor insira o conteúdo da nota",
  mode: "modo de nota",
  noteNumber: "Número de notas"
};
const tag = {
  needTag: "Por favor insira a etiqueta",
  removeTagSuccess: "Tag excluída com sucesso",
  name: "Rótulo",
  clearEmptyTag: "Limpe tags vazias com um clique",
  getTagListFail: "Falha ao obter a lista da estante",
  manage: "gerenciamento de tags",
  renameFail: "Falha ao renomear estante:",
  tagTitle: "nome da etiqueta"
};
const statistics = {
  bookUnit: "Livro",
  noteUnit: "Capítulo",
...
const sort = {
  ...
  updateTime: "Li recentemente"
};
const search = {
  searchRange: "Pesquise livros, notas, tags, destaques, estante"
};
const pt = {
  menu,
  setting,
