...
const common = {
  ...
  add: "añadir",
  copy: "Copiar",
  prewView: "Pagina anterior",
  getFirstView: "Ya la primera pagina",
  getLastView: "Ya la ultima pagina",
  nextView: "Siguiente página",
  comeFrom: "de",
  action: "funcionar",
  rename: "Rebautizar",
  search: "buscar",
  noRegList: "No hay lista coincidente"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "numero de libros",
  bookshelfManage: "Administrar estantería",
  bookshelfTitle: "nombre de estantería",
  clearEmptyBookshelf: "Limpia la estantería vacía con un clic",
  removeBookshelfSuccess: "Estantería eliminada con éxito",
  removeBookshelftSuccess: "Estantería eliminada con éxito",
  renameFail: "No se pudo cambiar el nombre de la estantería"
};
const note = {
  ...
  myNote: "mis notas",
  findNoteError: "Pérdida de datos: nota no encontrada localmente",
  writeYouNore: "Por favor ingrese el contenido de la nota.",
  mode: "modo nota",
  noteNumber: "numero de notas"
};
const tag = {
  needTag: "Por favor ingresa la etiqueta",
  removeTagSuccess: "Etiqueta eliminada correctamente",
  name: "Etiqueta",
  clearEmptyTag: "Borre etiquetas vacías con un clic",
  getTagListFail: "No se pudo obtener la lista de estanterías",
  manage: "gestión de etiquetas",
  renameFail: "No se pudo cambiar el nombre de la estantería:",
  tagTitle: "nombre de etiqueta"
};
const statistics = {
  bookUnit: "Libro",
  noteUnit: "Capítulo",
...
const sort = {
  ...
  readProgress: "progreso de lectura",
  readTime: "Tiempo de leer",
  updateTime: "Leído recientemente"
};
const search = {
  searchRange: "Buscar libros, notas, etiquetas, destacados, estantería"
};
const es = {
  menu,
  setting,
