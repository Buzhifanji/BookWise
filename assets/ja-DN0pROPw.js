...
const book = {
  ...
  bookNumber: "冊数",
  bookshelfManage: "本棚の管理",
  bookshelfTitle: "本棚名",
  clearEmptyBookshelf: "ワンクリックで空の本棚をクリア",
  removeBookshelfSuccess: "本棚は正常に削除されました",
  removeBookshelftSuccess: "本棚は正常に削除されました",
  renameFail: "本棚の名前変更に失敗しました"
};
const note = {
  ...
  write: "アイデアを書く",
  myNote: "私のノート",
  findNoteError: "データ損失: メモがローカルに見つかりません",
  writeYouNore: "メモの内容を入力してください",
  mode: "ノートモード",
  noteNumber: "ノートの数"
};
const tag = {
  ...
  name: "ラベル",
  clearEmptyTag: "ワンクリックで空のタグをクリア",
  getTagListFail: "本棚リストの取得に失敗しました",
  manage: "タグ管理",
  renameFail: "本棚の名前を変更できませんでした:",
  tagTitle: "タグ名"
};
const statistics = {
  bookUnit: "本",
...
const search = {
  searchRange: "本、メモ、タグ、ハイライト、本棚を検索"
};
const ja = {
  menu,
  setting,
