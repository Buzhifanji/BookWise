...
const common = {
  ...
  add: "Optellen bij",
  copy: "kopiëren",
  prewView: "Vorige bladzijde",
  getFirstView: "Al de eerste pagina",
  getLastView: "Alweer de laatste pagina",
  nextView: "Volgende bladzijde",
  comeFrom: "van",
  action: "bedienen",
  rename: "Hernoemen",
  search: "zoekopdracht",
  noRegList: "Geen overeenkomende lijst"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Aantal boeken",
  bookshelfManage: "Beheer boekenplank",
  bookshelfTitle: "naam boekenplank",
  clearEmptyBookshelf: "Ruim lege boekenplank op met één klik",
  removeBookshelfSuccess: "Boekenplank succesvol verwijderd",
  removeBookshelftSuccess: "Boekenplank succesvol verwijderd",
  renameFail: "Kan de naam van de boekenplank niet wijzigen"
};
const note = {
  ...
  myNote: "mijn notities",
  findNoteError: "Gegevensverlies: Opmerking niet lokaal gevonden",
  writeYouNore: "Voer de inhoud van de notitie in",
  mode: "notitiemodus",
  noteNumber: "Aantal notities"
};
const tag = {
  needTag: "Voer een tag in",
  removeTagSuccess: "Tag succesvol verwijderd",
  name: "Etiket",
  clearEmptyTag: "Wis lege tags met één klik",
  getTagListFail: "Kan de boekenplanklijst niet ophalen",
  manage: "tagbeheer",
  renameFail: "Kan de naam van de boekenplank niet wijzigen:",
  tagTitle: "tagnaam"
};
...
const sort = {
  ...
  readProgress: "voortgang lezen",
  readTime: "Leestijd",
  updateTime: "Onlangs gelezen"
};
const search = {
  searchRange: "Zoek boeken, notities, tags, hoogtepunten, boekenplank"
};
const nl = {
  menu,
  setting,
