...
const common = {
  ...
  prewView: "上一页",
  nextView: "下一页",
  getLastView: "已经是最后一页了",
  getFirstView: "已经是第一页了",
  comeFrom: "来自",
  action: "操作",
  rename: "重命名",
  search: "搜索",
...
const book = {
  ...
  removeBookshelfSuccess: "移除书架成功",
  bookshelfManage: "管理书架",
  bookshelfTitle: "书架名",
  bookNumber: "书籍数量",
  clearEmptyBookshelf: "一键清空空书架",
  renameFail: "重命名书架失败",
  removeBookshelftSuccess: "移除书架成功"
};
const note = {
  addNoteFail: "添加笔记失败",
  ...
  write: "写想法",
  myNote: "我的笔记",
  findNoteError: "数据丢失：本地未找到笔记",
  writeYouNore: "请输入笔记内容",
  mode: "笔记模式",
  noteNumber: "笔记数量"
};
const tag = {
  ...
  manage: "标签管理",
  getTagListFail: "获取书架列表失败",
  renameFail: "重命名书架失败：",
  tagTitle: "标签名",
  clearEmptyTag: "一键清空空标签"
};
const statistics = {
  reading: "在读",
  total: "总数量",
