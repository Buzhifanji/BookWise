...
const common = {
  ...
  rename: "Gi nytt navn",
  search: "Søk",
  noRegList: "Ingen samsvarende liste"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Antall bøker",
  bookshelfManage: "Administrer bokhylle",
  bookshelfTitle: "bokhyllenavn",
  clearEmptyBookshelf: "Rydd tom bokhylle med ett klikk",
  removeBookshelfSuccess: "Bokhyllen ble fjernet",
  removeBookshelftSuccess: "Bokhyllen ble fjernet",
  renameFail: "Kunne ikke gi nytt navn til bokhyllen"
};
const note = {
  ...
  write: "skrive ideer",
  myNote: "mine notater",
  findNoteError: "Datatap: Merket ble ikke funnet lokalt",
  writeYouNore: "Vennligst skriv inn notatinnholdet",
  mode: "notatmodus",
  noteNumber: "Antall notater"
};
const tag = {
  needTag: "Vennligst skriv inn tag",
  removeTagSuccess: "Taggen er slettet",
  name: "Merkelapp",
  clearEmptyTag: "Fjern tomme tagger med ett klikk",
  getTagListFail: "Kunne ikke hente bokhyllelisten",
  manage: "tag administrasjon",
  renameFail: "Kunne ikke gi nytt navn til bokhyllen:",
  tagTitle: "merkenavn"
};
const statistics = {
...
const sort = {
  addTime: "legge til tid",
  asc: "Stigende rekkefølge",
  desc: "Synkende rekkefølge",
  readProgress: "lesefremgang",
  readTime: "Lesetid",
  updateTime: "Nylig lest"
};
const search = {
  searchRange: "Søk i bøker, notater, tagger, høydepunkter, bokhylle"
};
const no = {
  menu,
  setting,
