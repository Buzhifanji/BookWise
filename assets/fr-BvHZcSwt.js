...
const common = {
  ...
  add: "Ajouter à",
  copy: "copie",
  prewView: "Page précédente",
  getFirstView: "Déjà la première page",
  getLastView: "Déjà la dernière page",
  nextView: "Page suivante",
  comeFrom: "depuis",
  action: "fonctionner",
  rename: "Renommer",
  search: "recherche",
  noRegList: "Aucune liste correspondante"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Nombre de livres",
  bookshelfManage: "Gérer la bibliothèque",
  bookshelfTitle: "nom de la bibliothèque",
  clearEmptyBookshelf: "Effacez une bibliothèque vide en un seul clic",
  removeBookshelfSuccess: "Bibliothèque supprimée avec succès",
  removeBookshelftSuccess: "Bibliothèque supprimée avec succès",
  renameFail: "Échec du renommage de la bibliothèque"
};
const note = {
  ...
  myNote: "mes notes",
  findNoteError: "Perte de données : note introuvable localement",
  writeYouNore: "Veuillez saisir le contenu de la note",
  mode: "mode note",
  noteNumber: "Nombre de notes"
};
const tag = {
  needTag: "Veuillez saisir le tag",
  removeTagSuccess: "Balise supprimée avec succès",
  name: "Étiquette",
  clearEmptyTag: "Effacez les balises vides en un seul clic",
  getTagListFail: "Échec de l'obtention de la liste des bibliothèques",
  manage: "gestion des balises",
  renameFail: "Échec du changement de nom de la bibliothèque :",
  tagTitle: "nom de la balise"
};
const statistics = {
  bookUnit: "Livre",
  noteUnit: "Chapitre",
...
const sort = {
  ...
  updateTime: "Lu récemment"
};
const search = {
  searchRange: "Rechercher des livres, des notes, des balises, des surlignages, une bibliothèque"
};
const fr = {
  menu,
  setting,
