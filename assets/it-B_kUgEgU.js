...
const common = {
  ...
  add: "aggiungere a",
  copy: "copia",
  prewView: "Pagina precedente",
  getFirstView: "Già la prima pagina",
  getLastView: "Già l'ultima pagina",
  nextView: "Pagina successiva",
  comeFrom: "da",
  action: "operare",
  rename: "Rinominare",
  search: "ricerca",
  noRegList: "Nessun elenco corrispondente"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Numero di libri",
  bookshelfManage: "Gestisci la libreria",
  bookshelfTitle: "nome della libreria",
  clearEmptyBookshelf: "Cancella lo scaffale vuoto con un clic",
  removeBookshelfSuccess: "Libreria rimossa con successo",
  removeBookshelftSuccess: "Libreria rimossa con successo",
  renameFail: "Impossibile rinominare lo scaffale"
};
const note = {
  ...
  write: "scrivere idee",
  myNote: "I miei appunti",
  findNoteError: "Perdita di dati: nota non trovata localmente",
  writeYouNore: "Inserisci il contenuto della nota",
  mode: "modalità nota",
  noteNumber: "Numero di note"
};
const tag = {
  needTag: "Inserisci l'etichetta",
  removeTagSuccess: "Tag eliminato con successo",
  name: "Etichetta",
  clearEmptyTag: "Cancella i tag vuoti con un clic",
  getTagListFail: "Impossibile ottenere l'elenco degli scaffali",
  manage: "gestione delle etichette",
  renameFail: "Impossibile rinominare lo scaffale:",
  tagTitle: "nome dell'etichetta"
};
const statistics = {
  bookUnit: "Libro",
  noteUnit: "Capitolo",
...
const sort = {
  ...
  readProgress: "progressi nella lettura",
  readTime: "Momento della lettura",
  updateTime: "Letto di recente"
};
const search = {
  searchRange: "Cerca libri, note, tag, evidenziazioni, libreria"
};
const it = {
  menu,
  setting,
