...
const common = {
  ...
  copy: "کپی 🀄",
  prewView: "صفحه قبلی",
  getFirstView: "در حال حاضر صفحه اول",
  getLastView: "در حال حاضر آخرین صفحه",
  nextView: "صفحه بعد",
  comeFrom: "از جانب",
  action: "عمل کنند",
  rename: "تغییر نام دهید",
  search: "جستجو کردن",
  noRegList: "لیست منطبقی وجود ندارد"
};
const readMode = {
  double: "حالت دو صفحه",
  scroll: "حالت اسکرول",
...
const book = {
  ...
  bookNumber: "تعداد کتاب",
  bookshelfManage: "مدیریت قفسه کتاب",
  bookshelfTitle: "نام قفسه کتاب",
  clearEmptyBookshelf: "قفسه خالی کتاب را با یک کلیک پاک کنید",
  removeBookshelfSuccess: "قفسه کتاب با موفقیت حذف شد",
  removeBookshelftSuccess: "قفسه کتاب با موفقیت حذف شد",
  renameFail: "تغییر نام قفسه کتاب انجام نشد"
};
const note = {
  ...
  write: "ایده بنویس",
  myNote: "نوشته های من",
  findNoteError: "از دست دادن داده: یادداشت به صورت محلی یافت نشد",
  writeYouNore: "لطفا محتوای یادداشت را وارد کنید",
  mode: "حالت یادداشت",
  noteNumber: "تعداد یادداشت ها"
};
const tag = {
  needTag: "لطفا برچسب را وارد کنید",
  removeTagSuccess: "برچسب با موفقیت حذف شد",
  name: "برچسب",
  clearEmptyTag: "برچسب های خالی را با یک کلیک پاک کنید",
  getTagListFail: "فهرست قفسه کتاب دریافت نشد",
  manage: "مدیریت برچسب",
  renameFail: "تغییر نام قفسه کتاب انجام نشد:",
  tagTitle: "نام تگ"
};
...
const sort = {
  addTime: "اضافه کردن زمان",
  asc: "ترتیب صعودی",
  desc: "ترتیب نزولی",
  readProgress: "پیشرفت خواندن",
  readTime: "زمان خواندن",
  updateTime: "اخیرا خوانده شده است"
};
const search = {
  searchRange: "جستجوی کتاب ها، یادداشت ها، برچسب ها، نکات برجسته، قفسه کتاب"
};
const fa = {
  menu,
  setting,
