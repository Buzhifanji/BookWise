...
const common = {
  ...
  add: "Додати до",
  copy: "копія",
  prewView: "Попередня сторінка",
  getFirstView: "Вже перша сторінка",
  getLastView: "Вже остання сторінка",
  nextView: "Наступна сторінка",
  comeFrom: "від",
  action: "оперувати",
  rename: "Перейменувати",
  search: "пошук",
  noRegList: "Немає відповідного списку"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Кількість книг",
  bookshelfManage: "Керуйте книжковою полицею",
  bookshelfTitle: "назва книжкової полиці",
  clearEmptyBookshelf: "Очистіть порожню книжкову полицю одним клацанням миші",
  removeBookshelfSuccess: "Книжкову полицю видалено",
  removeBookshelftSuccess: "Книжкову полицю видалено",
  renameFail: "Не вдалося перейменувати книжкову полицю"
};
const note = {
  ...
  write: "пишіть ідеї",
  myNote: "мої нотатки",
  findNoteError: "Втрата даних: примітка не знайдена локально",
  writeYouNore: "Будь ласка, введіть зміст примітки",
  mode: "режим нот",
  noteNumber: "Кількість нот"
};
const tag = {
  needTag: "Будь ласка, введіть тег",
  removeTagSuccess: "Тег успішно видалено",
  name: "Мітка",
  clearEmptyTag: "Очистіть порожні теги одним клацанням миші",
  getTagListFail: "Не вдалося отримати список книжкової полиці",
...
const sort = {
  ...
  updateTime: "Нещодавно прочитав"
};
const search = {
  searchRange: "Пошук книг, нотаток, тегів, виділень, книжкової полиці"
};
const uk = {
  menu,
  setting,
