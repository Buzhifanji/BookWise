...
const book = {
  ...
  bookNumber: "Kitap sayısı",
  bookshelfManage: "Kitap rafını yönet",
  bookshelfTitle: "kitaplık adı",
  clearEmptyBookshelf: "Boş kitaplığı tek tıklamayla temizleyin",
  removeBookshelfSuccess: "Kitaplık başarıyla kaldırıldı",
  removeBookshelftSuccess: "Kitaplık başarıyla kaldırıldı",
  renameFail: "Kitap rafı yeniden adlandırılamadı"
};
const note = {
  ...
  mode: "not modu",
  noteNumber: "Not sayısı"
};
const tag = {
  needTag: "Lütfen etiketi girin",
  removeTagSuccess: "Etiket başarıyla silindi",
  name: "Etiket",
  clearEmptyTag: "Boş etiketleri tek tıklamayla temizleyin",
  getTagListFail: "Kitaplık listesi alınamadı",
  manage: "etiket yönetimi",
  renameFail: "Kitap rafı yeniden adlandırılamadı:",
  tagTitle: "etiket adı"
};
const statistics = {
...
const search = {
  searchRange: "Kitapları, notları, etiketleri, öne çıkanları, kitap rafını arayın"
};
const tr = {
  menu,
  setting,
