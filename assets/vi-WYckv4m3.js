...
const common = {
  ...
  rename: "Đổi tên",
  search: "tìm kiếm",
  noRegList: "Không có danh sách phù hợp"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Số lượng sách",
  bookshelfManage: "Quản lý giá sách",
  bookshelfTitle: "tên giá sách",
  clearEmptyBookshelf: "Xóa giá sách trống chỉ bằng một cú nhấp chuột",
  removeBookshelfSuccess: "Đã xóa giá sách thành công",
  removeBookshelftSuccess: "Đã xóa giá sách thành công",
  renameFail: "Không đổi tên được giá sách"
};
const note = {
  ...
  findNoteError: "Mất dữ liệu: Không tìm thấy ghi chú cục bộ",
  writeYouNore: "Vui lòng nhập nội dung ghi chú",
  mode: "chế độ ghi chú",
  noteNumber: "Số lượng ghi chú"
};
const tag = {
  needTag: "Vui lòng nhập thẻ",
  removeTagSuccess: "Đã xóa thẻ thành công",
  name: "Nhãn",
  clearEmptyTag: "Xóa các thẻ trống bằng một cú nhấp chuột",
  getTagListFail: "Không lấy được danh sách giá sách",
  manage: "quản lý thẻ",
  renameFail: "Không thể đổi tên giá sách:",
  tagTitle: "tên thẻ"
};
const statistics = {
  bookUnit: "Sách",
...
const sort = {
  ...
  updateTime: "Gần đây đã đọc"
};
const search = {
  searchRange: "Tìm kiếm sách, ghi chú, thẻ, điểm nổi bật, giá sách"
};
const vi = {
  menu,
  setting,
