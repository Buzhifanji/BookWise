...
const common = {
  ...
  add: "اضف إليه",
  copy: "ينسخ",
  prewView: "الصفحة السابقة",
  getFirstView: "بالفعل الصفحة الأولى",
  getLastView: "بالفعل الصفحة الأخيرة",
  nextView: "الصفحة التالية",
  comeFrom: "من",
  action: "العمل",
  rename: "إعادة تسمية",
  search: "يبحث",
  noRegList: "لا توجد قائمة مطابقة"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "عدد الكتب",
  bookshelfManage: "إدارة رف الكتب",
  bookshelfTitle: "اسم رف الكتب",
  clearEmptyBookshelf: "مسح رف الكتب الفارغ بنقرة واحدة",
  removeBookshelfSuccess: "تمت إزالة رف الكتب بنجاح",
  removeBookshelftSuccess: "تمت إزالة رف الكتب بنجاح",
  renameFail: "فشلت إعادة تسمية رف الكتب"
};
const note = {
  ...
  write: "كتابة الأفكار",
  myNote: "ملاحظاتي",
  findNoteError: "فقدان البيانات: لم يتم العثور على الملاحظة محليًا",
  writeYouNore: "الرجاء إدخال محتوى الملاحظة",
  mode: "وضع الملاحظة",
  noteNumber: "عدد الملاحظات"
};
const tag = {
  needTag: "الرجاء إدخال العلامة",
  removeTagSuccess: "تم حذف العلامة بنجاح",
  name: "ملصق",
  clearEmptyTag: "مسح العلامات الفارغة بنقرة واحدة",
  getTagListFail: "فشل الحصول على قائمة رف الكتب",
  manage: "إدارة العلامات",
  renameFail: "فشلت إعادة تسمية رف الكتب:",
  tagTitle: "اسم العلامة"
};
const statistics = {
  bookUnit: "كتاب",
  noteUnit: "الفصل",
...
const sort = {
  ...
  updateTime: "قرأت مؤخرا"
};
const search = {
  searchRange: "البحث في الكتب والملاحظات والعلامات والإبرازات ورف الكتب"
};
const ar = {
  menu,
  setting,
