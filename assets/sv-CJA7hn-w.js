...
const common = {
  ...
  add: "Lägg till",
  copy: "kopiera",
  prewView: "Föregående sida",
  getFirstView: "Redan första sidan",
  getLastView: "Redan sista sidan",
  nextView: "Nästa sida",
  comeFrom: "från",
  action: "fungera",
  rename: "Döp om",
  search: "Sök",
  noRegList: "Ingen matchande lista"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Antal böcker",
  bookshelfManage: "Hantera bokhylla",
  bookshelfTitle: "bokhyllans namn",
  clearEmptyBookshelf: "Rensa tom bokhylla med ett klick",
  removeBookshelfSuccess: "Bokhyllan har tagits bort",
  removeBookshelftSuccess: "Bokhyllan har tagits bort",
  renameFail: "Det gick inte att byta namn på bokhyllan"
};
const note = {
  ...
  write: "skriva idéer",
  myNote: "mina anteckningar",
  findNoteError: "Dataförlust: Anteckningen hittades inte lokalt",
  writeYouNore: "Ange anteckningens innehåll",
  mode: "notläge",
  noteNumber: "Antal anteckningar"
};
const tag = {
  needTag: "Vänligen ange tagg",
  removeTagSuccess: "Taggen har tagits bort",
  name: "Märka",
  clearEmptyTag: "Rensa tomma taggar med ett klick",
  getTagListFail: "Det gick inte att hämta bokhyllalistan",
  manage: "tagghantering",
  renameFail: "Det gick inte att byta namn på bokhyllan:",
  tagTitle: "taggnamn"
};
const statistics = {
...
const sort = {
  addTime: "lägga till tid",
  asc: "Stigande ordning",
  desc: "fallande ordning",
  readProgress: "läsframsteg",
  readTime: "Lästid",
  updateTime: "Nyligen läst"
};
const search = {
  searchRange: "Sök i böcker, anteckningar, taggar, höjdpunkter, bokhylla"
};
const sv = {
  menu,
  setting,
