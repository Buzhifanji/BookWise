...
const book = {
  ...
  bookNumber: "권수",
  bookshelfManage: "책장 관리",
  bookshelfTitle: "책장 이름",
  clearEmptyBookshelf: "한 번의 클릭으로 빈 책장 정리",
  removeBookshelfSuccess: "책장이 삭제되었습니다.",
  removeBookshelftSuccess: "책장이 삭제되었습니다.",
  renameFail: "서가 이름을 바꾸지 못했습니다."
};
const note = {
  ...
  write: "아이디어를 쓰다",
  myNote: "내 메모",
  findNoteError: "데이터 손실: 로컬에서 메모를 찾을 수 없음",
  writeYouNore: "메모 내용을 입력해주세요",
  mode: "노트 모드",
  noteNumber: "음표 수"
};
const tag = {
  ...
  name: "상표",
  clearEmptyTag: "한 번의 클릭으로 빈 태그 지우기",
  getTagListFail: "서가 목록을 가져오지 못했습니다.",
  manage: "태그 관리",
  renameFail: "책장 이름을 바꾸지 못했습니다.",
  tagTitle: "태그 이름"
};
const statistics = {
  bookUnit: "책",
...
const search = {
  searchRange: "책, 메모, 태그, 하이라이트, 책장 검색"
};
const ko = {
  menu,
  setting,
