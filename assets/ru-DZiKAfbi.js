...
const common = {
  ...
  add: "добавить в",
  copy: "копировать",
  prewView: "Предыдущая страница",
  getFirstView: "Уже первая страница",
  getLastView: "Уже последняя страница",
  nextView: "Следущая страница",
  comeFrom: "от",
  action: "действовать",
  rename: "Переименовать",
  search: "поиск",
  noRegList: "Нет подходящего списка"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Количество книг",
  bookshelfManage: "Управление книжной полкой",
  bookshelfTitle: "название книжной полки",
  clearEmptyBookshelf: "Очистите пустую книжную полку одним щелчком мыши",
  removeBookshelfSuccess: "Книжная полка успешно удалена",
  removeBookshelftSuccess: "Книжная полка успешно удалена",
  renameFail: "Не удалось переименовать книжную полку."
};
const note = {
  ...
  write: "писать идеи",
  myNote: "мои заметки",
  findNoteError: "Потеря данных: Примечание не найдено локально",
  writeYouNore: "Пожалуйста, введите содержание заметки",
  mode: "режим заметок",
  noteNumber: "Количество нот"
};
const tag = {
  needTag: "Пожалуйста, введите тег",
  removeTagSuccess: "Тег успешно удален",
  name: "Этикетка",
  clearEmptyTag: "Очистка пустых тегов одним щелчком мыши",
  getTagListFail: "Не удалось получить список книжных полок.",
  manage: "управление тегами",
  renameFail: "Не удалось переименовать книжную полку:",
  tagTitle: "название тэга"
};
const statistics = {
  bookUnit: "Книга",
  noteUnit: "Глава",
...
const sort = {
  ...
  updateTime: "Недавно прочитал"
};
const search = {
  searchRange: "Поиск книг, заметок, тегов, основных моментов, книжной полки"
};
const ru = {
  menu,
  setting,
