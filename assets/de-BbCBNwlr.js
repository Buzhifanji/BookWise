...
const common = {
  ...
  add: "Hinzufügen zu",
  copy: "Kopieren",
  prewView: "Vorherige Seite",
  getFirstView: "Schon die erste Seite",
  getLastView: "Schon die letzte Seite",
  nextView: "Nächste Seite",
  comeFrom: "aus",
  action: "arbeiten",
  rename: "Umbenennen",
  search: "suchen",
  noRegList: "Keine passende Liste"
};
const readMode = {
...
const book = {
  ...
  bookNumber: "Anzahl Bücher",
  bookshelfManage: "Bücherregal verwalten",
  bookshelfTitle: "Name des Bücherregals",
  clearEmptyBookshelf: "Räumen Sie leere Bücherregale mit einem Klick auf",
  removeBookshelfSuccess: "Bücherregal erfolgreich entfernt",
  removeBookshelftSuccess: "Bücherregal erfolgreich entfernt",
  renameFail: "Bücherregal konnte nicht umbenannt werden"
};
const note = {
  ...
  findNoteError: "Datenverlust: Notiz lokal nicht gefunden",
  writeYouNore: "Bitte geben Sie den Notizinhalt ein",
  mode: "Notenmodus",
  noteNumber: "Anzahl der Noten"
};
const tag = {
  needTag: "Bitte Tag eingeben",
  removeTagSuccess: "Tag erfolgreich gelöscht",
  name: "Etikett",
  clearEmptyTag: "Leere Tags mit einem Klick löschen",
  getTagListFail: "Bücherregalliste konnte nicht abgerufen werden",
  manage: "Tag-Verwaltung",
  renameFail: "Bücherregal konnte nicht umbenannt werden:",
  tagTitle: "Verlinke den Namen"
};
const statistics = {
  bookUnit: "Buch",
  noteUnit: "Kapitel",
...
const sort = {
  ...
  readProgress: "Lesefortschritt",
  readTime: "Lesezeit",
  updateTime: "Kürzlich gelesen"
};
const search = {
  searchRange: "Durchsuchen Sie Bücher, Notizen, Tags, Markierungen und Bücherregale"
};
const de = {
  menu,
  setting,
