...
const book = {
  ...
  getBookReadTimeFail: "讀取圖書閱讀時長列表失敗",
  getBookReadTimeListFail: "讀取圖書閱讀時長列表失敗",
...
const note = {
  ...
  noteDetail: "筆記詳情",
  empty: "筆記列表為空",
  emptyNoteListTip: "在您的书籍列表界面，選擇一本閱讀，然後選中吸引您注意力的文字，在弹出的對話框中輸入您的思考",
  placeholder: "寫下此時的想法...",
  write: "寫想法",
  myNote: "我的筆記",
